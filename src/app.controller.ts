...
export class AppController {
  ...
  @Get("/exchangerate/")
  async getExchangeRate(@Query('monedainicial') monedainicial: string , @Query('monedafinal') monedafinal: string  , @Query('fecha') fecha: Date, @Query('cantidad') cantidad: number ): Promise<any> {
